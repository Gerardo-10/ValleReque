window.initSecurityModals = function () {
    ...
    formAgregarEmpleado.addEventListener('submit', function (e) {
        ...
        if (!nombre || !apellido || !dni || !direccion || !telefono || !correo || !fechaNacimiento || !area) {
            Swal.fire({ icon: 'warning', title: 'Formulario incompleto', text: 'Por favor, completa todos los campos obligatorios.' });
            return;
        }
        ...
        Swal.fire({ title: 'Registrando...', text: 'Por favor espera', allowOutsideClick: false, didOpen: () => Swal.showLoading() });
